...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recipient : EditText = findViewById(R.id.recipientEditText)
        val message : EditText = findViewById(R.id.messageInstert)
        ...
        myButton.setOnClickListener {
            ...
            if (validationResult == null) {
                ...
                intent.putExtra("RecipientValue", recipientToSend)
